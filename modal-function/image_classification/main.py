...
def image_classification_model(dataset, layers, epochs, batch_size, lr):
    ...
    ds_train = ds_train.batch(batch_size) # batch
    ...
    ds_test = ds_test.batch(batch_size) # batch
    ...
    # Compile
    model.compile(
        optimizer=tf.keras.optimizers.Adam(lr or 0.01), # learning rate
